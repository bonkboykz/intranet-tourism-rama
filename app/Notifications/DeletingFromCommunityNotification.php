...
class DeletingFromCommunityNotification extends Notification implements ShouldQueue
{
    ...
    public function toDatabase($notifiable) {
        return [
            'message' => $this->user->name . ' removed you from ' . $this->community->name . ' community.',
