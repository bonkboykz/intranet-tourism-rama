...
const Pautan = () => {
    ...
    const PautanHandleAddApp = async () => {
        ...
        try {
            ...
            toastError("Error adding app", error.message);
        }
    };
    ...
    const PautanHandleUpdateApp = async () => {
        ...
        if (
            newAppName &&
            isNameDuplicate &&
            currentApp?.label !== updatedApp.label
        ) {
            toastError("App name already exists.");
            return;
        }

        console.log(newAppUrl, isUrlDuplicate, currentApp?.url, newAppUrl);
        ...
        try {
            ...
            toastError("Error updating app", error.message);
        }
    };
    ...
    const PautanHandleDeleteApp = async () => {
        ...
        try {
            ...
            toastError("Error deleting app", error.message);
        }
    };
