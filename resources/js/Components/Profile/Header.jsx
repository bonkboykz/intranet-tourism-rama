...
function ProfileImage({ name, src, alt, className, rounded, tag, isOnline }) {
    ...
    return (
        <div
            className={`flex overflow-hidden relative z-0 max-w-full aspect-square ${className} max-md:w-32 max-md:justify-start`}
        >
            <img
                ...
                >
                    ...
                    <div className="flex-row max-md:flex-col z-100 w-auto h-auto bg-white flex gap-4 -mt-16 max-md:-mt-14 max-md:-ml-7 px-10 z-1">
                        ...
                        <div className="flex flex-col w-full self-start mt-16 max-md:mx-0 max-md:-mt-12">
                            ...
                            <div className="-mt-2 text-xs font-semibold text-neutral-800 text-opacity-50 max-md:text-sm max-md:ml-2 max-md:-mt-4 ">
                                {status}
                            </div>
                        </div>
                    </div>
